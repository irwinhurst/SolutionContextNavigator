...
using IrwinHurst.ContextNavigator;

namespace ContextNavigator_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new ContextNavigatorPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(IrwinHurst.ContextNavigator.GuidList.guidContextNavigatorCmdSet, (int)IrwinHurst.ContextNavigator.PkgCmdIDList.cmdidContextNavigator);
