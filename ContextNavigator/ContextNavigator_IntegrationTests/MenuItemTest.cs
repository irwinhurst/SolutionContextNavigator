...
namespace ContextNavigator_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(IrwinHurst.ContextNavigator.GuidList.guidContextNavigatorCmdSet, (int)IrwinHurst.ContextNavigator.PkgCmdIDList.cmdidContextNavigator);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "ContextNavigator", "IrwinHurst.ContextNavigator.ContextNavigatorPackage");
